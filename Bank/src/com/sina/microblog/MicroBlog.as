...
//			trace("========================================");
		 ...
		 */
		public function follow(userID:String="0", screenName:String=null):void
		{
			var req:URLRequest;
			
			var params:Object = { };
			
			if (userID.length > 0) params.uid = userID;
			...
			uri = API.STATUS_FOLLOW;
				...
				addProcessor(uri, processGeneralApi, MicroBlogEvent.FOLLOW_STATUS_RESULT, MicroBlogErrorEvent.FOLLOW_STATUS_ERROR);
